...
final class Test_Icon_Library_Sanitize_Svg extends WP_UnitTestCase
{
    ...
    public function test_entity_encoded_attribute_name_is_rejected(): void
    {
        ...
        $this->assertSame('', icon_library_sanitize_svg($svg));
    }
