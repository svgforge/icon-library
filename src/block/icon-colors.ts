 ...
 *
 * Symbols with two or more real, distinct colors are "colored": they keep their
 * baked-in fill colors and are not affected by the block's Gutenberg color
 * controls (`fill: currentColor` only replaces inherited/unset fills).
 *
 * @package
 */
